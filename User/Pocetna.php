				...
				<p>
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<ul class="nav navbar-nav">
								<li><a href="UpravljanjeDogadaja.php">Upravljanje događaja</a></li><br>
								<li><a href="UpravljanjeZahtjeva.php">Upravljanje zahtjeva</a></li><br>
								<li><a href="UpravljanjeIncidenata.php">Upravljanje incidenata</a></li><br>
							</ul>
						</div>
					</div>
				</p>
