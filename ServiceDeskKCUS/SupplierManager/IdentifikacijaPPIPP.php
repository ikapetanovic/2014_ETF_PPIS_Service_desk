			...
			<div class="jumbotron">
				<p>
					<div class="panel panel-primary">
						<div class="panel-heading">Identifikacija poslovnih potreba i priprema poslovanja</div>
						<div class="panel-body">
							<ul class="nav navbar-nav">
								<li><a href="DefiniranjeGPIU.php">Definiranje generalnih pravila i uslova</a></li><br>
								<li><a href="PregledGPIU.php">Pregled generalnih pravila i uslova</a></li><br>
								<li><a href="DefiniranjeSPIU.php">Definiranje specifičnih pravila i uslova</a></li><br>
								<li><a href="PregledSPIU.php">Pregled specifičnih pravila i uslova</a></li><br>
							</ul>
						</div>
					</div>
				</p>
