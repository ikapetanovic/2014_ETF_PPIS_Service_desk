			...
			<div class="jumbotron">
				<p>
					<div class="panel panel-primary">
						<div class="panel-heading">Upravljanje događaja</div>
						<div class="panel-body">
							<ul class="nav navbar-nav">
								<li><a href="KreiranjeDogadaja.php">Kreiranje događaja</a></li><br>
								<li><a href="PregledanjeDogadaja.php">Pregledanje događaja</a></li><br>
							</ul>
						</div>
					</div>
				</p>
