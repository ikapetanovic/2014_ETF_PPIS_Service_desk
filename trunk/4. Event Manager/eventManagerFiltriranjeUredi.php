<?php
	...
	try
	{
		...
		$q1 = mysql_query("SELECT datumVrijemePrijave, naslov, kategorija, podkategorija, model, uticaj, hitnost, prioritet, korisnik_idKorisnik FROM dogadjaj WHERE idDogadjaj = '$IDDogadjaj';") or die("Error in query: ".mysql_error());
