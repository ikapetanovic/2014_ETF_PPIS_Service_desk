<?php
	...
	try
	{
		...
		$q = mysql_query("SELECT idIncident, datumVrijemePrijave, korisnik, naslov, kategorija, podkategorija, konfiguracijskaStavka, prioritet, status  FROM incident;") or die("Error in query: ".mysql_error());
