<?php
	...
	try
	{
		...
		$q2 = mysql_query("SELECT datumVrijemePrijave, korisnik, odjel, tipPrijave, naslov, kategorija, podkategorija, model, povratnaInfoPreko, opis, komentar, uticaj, hitnost, prioritet, status, dodijeljenaGrupa FROM incident WHERE idIncident = '$_POST[IDIncident]';") or die("Error in query: ".mysql_error());
