							...
							<table class="table table-bordered">
								...
								<?php
									...
									while ($incident = mysql_fetch_assoc($rezultatSQLUpita))
									{
										...
										echo "<td><form method=\"POST\" action=\"AzuriranjeStanjaIncidenata.php\"><div class=\"form-group\"><select class=\"form-control\" name=\"stanje\" id=\"stanje\"/><option value=\"Kontrolirano\">Kontrolirano</option><option value=\"Eskalirano\">Eskalirano</option></select></div><div class=\"form-group\"><input type=\"hidden\" name=\"idIncidenta\" value=\"".$incident["id"]."\"/><button type=\"submit\" class=\"btn btn-primary\" id=\"azuriraj\">Ažuriraj</button></div></form></td>";
										echo "</tr>";
									}
									mysql_close();
								?>
