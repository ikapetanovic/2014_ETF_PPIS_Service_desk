							...
							<table class="table table-bordered">
								...
								<?php
									...
									while ($pravilo = mysql_fetch_assoc($rezultatSQLUpita))
									{
										...
										echo "<td><form method=\"POST\" action=\"BrisanjeGPIU.php\"><div class=\"form-group\"><input type=\"hidden\" name=\"idGeneralnogPravila\" value=\"".$pravilo["id"]."\"/><button type=\"submit\" class=\"btn btn-primary\" id=\"brisi\">Briši</button></div></form></td>";
										echo "</tr>";
									}
									mysql_close();
								?>
							</table>
							<form method="POST" class="form-horizontal" action="PregledGPIU.php">
