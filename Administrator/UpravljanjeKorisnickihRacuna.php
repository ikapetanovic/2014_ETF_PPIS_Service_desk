			...
			<div class="jumbotron">
				<p>
					<div class="panel panel-primary">
						<div class="panel-heading">Upravljanje korisničkih računa</div>
						<div class="panel-body">
							<ul class="nav navbar-nav">
								<li><a href="KreiranjeKorisnickihRacuna.php">Kreiranje korisničkih računa</a></li><br>
								<li><a href="PregledanjeKorisnickihRacuna.php">Pregledanje korisničkih računa</a></li><br>
							</ul>
						</div>
					</div>
				</p>
